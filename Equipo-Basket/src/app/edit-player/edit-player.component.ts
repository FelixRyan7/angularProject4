...
@Component({
  ...
  standalone: true,
  imports: [PlayersComponentComponent, DetailComponentComponent, CommonModule, FormsModule], // Agrega FormsModule aquí
...
export class EditPlayerComponent{
  ...
  constructor(private route: ActivatedRoute, private datosPlayersService: DatosPlayersService, private storage: Storage,) { }
  ...
  guardarCambios() {
    this.datosPlayersService.edit(this.player.id, this.player).then(() => {
